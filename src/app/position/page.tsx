...
import getAllSkills from '@/libs/getAllSkills';
import PositionSearchClient from '@/components/PositionSearchClient';
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-3xl text-gray-800 font-bold text-center mb-8">Find your Position</h1>
            <PositionSearchClient positions={positions} skills={skills.data}/>
